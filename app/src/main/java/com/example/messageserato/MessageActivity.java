package com.example.messageserato;

import static com.example.messageserato.MainActivity.PREF_NIGHT;
...
public class MessageActivity extends AppCompatActivity {
    public static final String EXTRA_MESSAGE = "com.example.messageserato.MESSAGE";
    public static final String EXTRA_RESULT = "com.example.messageserato.RESULT";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences preferences = getSharedPreferences("Serato", Activity.MODE_PRIVATE);
